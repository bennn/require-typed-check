...
(require require-typed-check/optional)
(require/typed/check/optional require-typed-check/test/basic/untyped
  (f (-> Natural Natural (Vectorof Boolean) Any)))

(require/typed/check/optional require-typed-check/test/basic/typed
  (g (-> Natural Natural (Vectorof Boolean) Any)))

(require/typed/check/optional require-typed-check/test/basic/shallow-lib
  (s (-> Natural Natural (Vectorof Boolean) Any)))

(require/typed/check/optional require-typed-check/test/basic/optional-lib
...
(module+ test
  ...
  (require/typed/check/optional racket/contract
